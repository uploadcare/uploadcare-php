...
class File
{
     ...
     * @param boolean $make_public (Optional) MUST be either true or false. true to make copied files available via
     *                             public links. false to reverse the behavior.
     * @param string  $pattern     (Optional) The parameter is used to specify file names Uploadcare passes to custom
     *                             storages. In case parameter is omitted, custom storage pattern is used.
     *                             Allowed values:
